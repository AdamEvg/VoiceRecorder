package com.voicerecorder.record
...
class RecordService: Service() {
    ...
    private var mDatabase: RecordsDao? = null
    ...
    private fun stopRecording() {
        ...
        recordingItem.recordName = mFileName.toString()
        recordingItem.recordPath = mFilePath.toString()
        recordingItem.recordLength = mElapsedMillis
        recordingItem.recordCreatingTime = System.currentTimeMillis()
